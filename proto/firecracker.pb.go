...
const file_firecracker_proto_rawDesc = "" +
	"\n" +
	"\x11firecracker.proto\x1a\vtypes.proto\"(\n" +
	"\x12PrepareShimRequest\x12\x12\n" +
	"\x04VMID\x18\x01 \x01(\tR\x04VMID\"\x9f\x01\n" +
	"\x13PrepareShimResponse\x12\x12\n" +
	"\x04VMID\x18\x01 \x01(\tR\x04VMID\x12\x1c\n" +
	"\tNamespace\x18\x02 \x01(\tR\tNamespace\x12,\n" +
	"\x11ShimSocketAddress\x18\x03 \x01(\tR\x11ShimSocketAddress\x12(\n" +
	"\x0fFCSocketAddress\x18\x04 \x01(\tR\x0fFCSocketAddress\"'\n" +
	"\x11RemoveShimRequest\x12\x12\n" +
	"\x04VMID\x18\x01 \x01(\tR\x04VMID\"\xd0\a\n" +
	...
	"\x15ContainerSnapshotPath\x18\x13 \x01(\tR\x15ContainerSnapshotPath\x12.\n" +
	"\n" +
	"MemBackend\x18\x14 \x01(\v2\x0e.MemoryBackendR\n" +
	"MemBackend\x120\n" +
	"\x13EnableDiffSnapshots\x18\x15 \x01(\bR\x13EnableDiffSnapshots\"\xb2\x01\n" +
