...
type FirecrackerMachineConfiguration struct {
	...
	TrackDirtyPages bool   `protobuf:"varint,3,opt,name=TrackDirtyPages,proto3" json:"TrackDirtyPages,omitempty"`
	...
	MemSizeMib           uint32   `protobuf:"varint,4,opt,name=MemSizeMib,proto3" json:"MemSizeMib,omitempty"`
	VcpuCount            uint32   `protobuf:"varint,5,opt,name=VcpuCount,proto3" json:"VcpuCount,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
var fileDescriptor_d938547f84707355 = []byte{
	...
	,
}
